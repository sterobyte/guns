...
const files = [
  ...
  path.join(root, "scripts", "mongo-backup-utils.mjs"),
  path.join(root, "scripts", "backup-mongo.mjs"),
  path.join(root, "scripts", "restore-mongo.mjs"),
  path.join(root, "scripts", "run-users-mongo-migration.mjs"),
  path.join(root, "scripts", "test-multiplayer.mjs"),
  path.join(root, "scripts", "watch-backend.mjs"),
  path.join(root, "server", "protocol.mjs"),
  path.join(root, "server", "arena.mjs"),
  path.join(root, "server", "match.mjs"),
